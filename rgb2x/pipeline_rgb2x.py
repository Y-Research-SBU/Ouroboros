...
class StableDiffusionAOVMatEstPipeline(
    ...
    def prepare_latents(
        ...
        generator,
        latents=None,
        noise='gaussian' # "gaussian", "pyramid", "zeros", "no"
    ):
        shape = (
            batch_size,
            num_channels_latents,
    ...
    def __call__(
        ...
        noise: str = "gaussian", # "gaussian", "pyramid", "zeros", "no"
    ):
        r"""
        ...
        if num_channels_latents + num_channels_image != self.unet.config.in_channels and noise != 'no':
            raise ValueError(
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                if noise == 'no':
                    scaled_latent_model_input = image_latents
                else:
